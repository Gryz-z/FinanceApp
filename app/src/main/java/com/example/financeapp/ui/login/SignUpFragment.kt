...
import com.example.financeapp.databinding.FragmentSignUpBinding // Asumiendo que tu binding se llama así

// Asumiendo que tu clase se llama SignUpFragment
class SignUpFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // (Por ejemplo, los listeners de tus botones)
        //
